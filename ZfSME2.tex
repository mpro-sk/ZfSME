...
% výšky \vsize (opravené z \hsize v pôvodnom komentári):
...
% Pôvodná definícia pre tit. stranu (potrebné \TitSkipMinus a \TitulMedzera)
...
\ifnum\pageno=-2 \NewPageIfEven \else  \fi
}}
