...
%\def\vycentruj{}          % pre kompatibilutu s pôvodným ZfSME
...
\let\MedSkip=\bigskip
%\def\SecLeft{1} % ak a používa \IfL, už to nie je potrebné
\fi
...
% Tlač pod/sekcie doplnená o zarovnanie textu vľavo (\fL)
  ...
  \def\printsec#1{\par \norempenalty-400 \bigskip
    ...
    {\IfL\secfont \noindent \dotocnum
    {\thetocnum\quad}#1\nbpar}%
    \nobreak \remskip.6\bigskipamount}%
